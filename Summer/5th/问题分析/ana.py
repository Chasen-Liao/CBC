...
# 在直角坐标系中绘制原始螺线和中心对称螺线
plt.subplot(2, 1, 1)
plt.plot(x, y, 'b-', linewidth=2, label='原始螺线')
plt.plot(-x, -y, 'g-', linewidth=2, label='中心对称螺线')
...
plt.plot(theta, r, 'b-', linewidth=2, label='原始螺线')
plt.plot(theta + np.pi, r, 'g-', linewidth=2, label='中心对称螺线')  # 极坐标系中对称变换为角度加π
